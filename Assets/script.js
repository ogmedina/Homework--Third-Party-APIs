...
//checks every 1000 ms to reset seconds in time
...
$(".saveBtn").on("click", function() {
    ...
    console.log(timeSaved, textAgenda);
...
//function to change the colors based on what time it is
...
//for loop to write the value of the class plus the number plus the description based on the number from getItem()
for (let i=9; i <=17; i++){
